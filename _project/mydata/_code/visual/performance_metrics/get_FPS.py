...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolo12n/multi_classes/202507060012_yolo12_Train2419_Val479/weights/best.pt', help='trained weights path')
    parser.add_argument('--batch', type=int, default=100, help='total batch size for all GPUs')

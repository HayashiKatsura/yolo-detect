...
def get_params():
    # params = {
    #     'weight': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolov8m/_defaultv8__202504171455/weights/best.pt', # 只需要指定权重即可
    #     'device': 'cuda:0',
    #     'layer': '1', # string
    #     'dataset': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/single_class/original/images/train',
    #     'num_images': 50,
    #     'save_path': '/home/panxiang/coding/kweilx/ultralytics/_visual/Receptive Field/erf_df.png'
    # }
    # return params
    params = {
        'weight': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolov8m/_defaultv8__202504171455/weights/best.pt', # 只需要指定权重即可
    ...
    base_save = '/home/panxiang/coding/kweilx/ultralytics/_visual/Receptive Field/df'
    import copy
    params_list = []
    for i in range(1,10):
        params_copy = copy.deepcopy(params)
        params_copy['layer'] = str(i)
        params_copy['save_path'] = os.path.join(base_save, f'erf_df_{i}.png')

...
names = [
    '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolov8m/20250426/202504260551_yolov8-EfficientNetV1spdconvdbTrp_Train70_VAL30_'
]
...
for i in names:
    ...
    plt.plot(data['   metrics/precision(B)'], label=os.path.basename(i))
plt.xlabel('epoch')
plt.title('precision')
...
for i in names:
    ...
    plt.plot(data['      metrics/recall(B)'], label=os.path.basename(i))
plt.xlabel('epoch')
plt.title('recall')
plt.legend(loc='upper left')
...
for i in names:
    ...
    plt.plot(data['       metrics/mAP50(B)'], label=os.path.basename(i))
plt.xlabel('epoch')
plt.title('mAP_0.5')
plt.legend(loc='upper left')
...
for i in names:
    ...
    plt.plot(data['    metrics/mAP50-95(B)'], label=os.path.basename(i))
plt.xlabel('epoch')
plt.title('mAP_0.5:0.95')
plt.legend(loc='upper left')

plt.tight_layout()
plt.savefig('/home/panxiang/coding/kweilx/ultralytics/_visual/metrice_curve.png')
...
for i in names:
    ...
    plt.plot(data['         train/box_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['         train/dfl_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['         train/cls_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/box_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/dfl_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
...
for i in names:
    ...
    plt.plot(data['           val/cls_loss'], label=os.path.basename(i))
plt.xlabel('epoch')
plt.title('val/cls_loss')
plt.legend(loc='upper left')

plt.tight_layout()
plt.savefig('/home/panxiang/coding/kweilx/ultralytics/_visual/loss_curve.png')

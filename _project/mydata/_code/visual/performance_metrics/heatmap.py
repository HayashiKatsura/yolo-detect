...
class yolo_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            # self.process(img_path, f'{save_path}/v12heat.png')
            self.process(img_path, f'{save_path}/{os.path.basename(img_path)}')
            

def get_params():
    params = {
        'weight': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolo12n/multi_classes/202507060012_yolo12_Train2419_Val479/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
         'layer': [14,17,20], # 
        # 'weight': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolo12n/multi_classes/202507061320_yolo12-MambaOutx4_Train2419_Val479/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        # 'layer': [10,13,16], # 
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    save_path = '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/test_images/0.5/heatmap12'
    # save_path = '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/test_images/0.5/heatchips'
    
    image_folder = '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/test_images/0.5/not_in_12'
    file_path_list = [os.path.join(image_folder, file_path) for file_path in os.listdir(image_folder) if file_path.endswith('.png')]

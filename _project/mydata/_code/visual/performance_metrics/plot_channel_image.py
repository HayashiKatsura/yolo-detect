...
if __name__ == '__main__':
    ...
    parser.add_argument('--base-weights', type=str, default='/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/prune/ok/202507162039-convnextv2-prune-only-convnextv2-prune/weights/model_c2f_v2.pt', help='base weights path')
    parser.add_argument('--prune-weights', type=str, default='/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/prune/ok/202507162039-convnextv2-prune-only-convnextv2-prune/weights/prune.pt', help='prune weights path')
    ...
    plt.tight_layout()
    plt.savefig('/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_code/visual/test_images/channels_chart.png')
    ...
    plt.title('Channel contrast diagram', fontdict={'fontsize':20})
    plt.tight_layout()
    plt.savefig('/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_code/visual/test_images/channels_chart_sort.png')

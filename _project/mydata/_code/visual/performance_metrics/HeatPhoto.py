...
def get_params():
    params = {
        'weight': '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_results/yolo12n/multi_classes/202507060012_yolo12_Train2419_Val479/weights/best.pt',  # 训练出来的权重文件
        'cfg': '/home/panxiang/coding/kweilx/ultralytics/ultralytics/cfg/models/12/yolo12.yaml',  # 训练权重对应的yaml配置文件
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/anomolies/new_source_total/cases/black/68A-01-Bin-065-0.png', 
          '/home/panxiang/coding/kweilx/ultralytics/_project/mydata/_a_datasets/anomolies/new_source_total/cases/black')  # 第一个是检测的文件, 第二个是保存的路径
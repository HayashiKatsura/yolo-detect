...
if __name__ == "__main__":
    ...
    for index in range(Out_Num):
        ...
        jpg_name_1  = os.path.join(Origin_JPEGImages_path, os.path.splitext(sample_xmls[0])[0] + '.png')
        jpg_name_2  = os.path.join(Origin_JPEGImages_path, os.path.splitext(sample_xmls[1])[0] + '.png')
        xml_name_1  = os.path.join(Origin_Annotations_path, sample_xmls[0])
        xml_name_2  = os.path.join(Origin_Annotations_path, sample_xmls[1])
        ...
        line_1 = convert_annotation(jpg_name_1, xml_name_1)
        line_2 = convert_annotation(jpg_name_2, xml_name_2)
        ...
        img.save(os.path.join(Out_JPEGImages_path, f'class_{os.path.basename(Origin_Annotations_path)}_mixup_{index}.png'))
        convert_to_yolo_format_and_save(
            box_data,
            os.path.join(Out_Annotations_path, f'class_{os.path.basename(Origin_Annotations_path)}_mixup_{index}.txt'),
        )

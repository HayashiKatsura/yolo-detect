...
class Model(nn.Module):
    ...
    def __init__(
        ...
        if Path(model).suffix in {".yaml", ".yml"}:
            self._new(model, task=task, verbose=verbose,session_id=session_id)
        else:
    ...
    def _new(self, cfg: str, task=None, model=None, verbose=False,session_id=None) -> None:
        """
        ...
        cfg_dict.update({"session_id": session_id})
        self.cfg = cfg

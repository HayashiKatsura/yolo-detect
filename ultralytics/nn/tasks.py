...
C3K2_CLASS = (C3k2_Faster, C3k2_ODConv, C3k2_Faster_EMA, C3k2_DBB, C3k2_DeepDBB, C3k2_WDBB, C3k2_CloAtt, C3k2_SCConv, C3k2_ScConv, C3k2_EMSC, C3k2_EMSCP, C3k2_KW, C3k2_DySnakeConv, C3k2_DCNv2, C3k2_DCNv3,
              ...
              C3k2_EBlock, C3k2_DBlock, C3k2_FDConv, C3k2_MambaOut_FDConv, C3k2_PFDConv, C3k2_FasterFD, C3k2_DSAN, C3k2_MambaOut_DSA, C3k2_DSA, C3k2_DSAN_EDFFN, C3k2_RMB,C3k2_GatedBlock
              )
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="yolov8n.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
        ...
        self.session_id = cfg.get("session_id", None)  # session id for logging
        self.model, self.save = parse_model(deepcopy(self.yaml), ch=ch, verbose=verbose, warehouse_manager=self.warehouse_manager,session_id=self.session_id)  # model, savelist
...
def parse_model(d, ch, verbose=True, warehouse_manager=None,session_id=None):  # model_dict, input_channels(3)
    ...
    if verbose:
        lgu.info(f"{'':>3}{'from':>20}{'n':>3}{'params':>10}  {'module':<45}{'arguments':<30}")
        LOGGER.info(f"\n{'':>3}{'from':>20}{'n':>3}{'params':>10}  {'module':<45}{'arguments':<30}") # TODO 模型日志
    ch = [ch]
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in ((
            ...
            MANet_Star, PSConv, RepHMS, CSP_MSCB_SC, LoGStem, MultiScaleConv,TripletAttention,
            ...
            if m in ((
                ...
                MANet_FasterBlock, MANet_FasterCGLU, MANet_Star, CSP_MSCB_SC,MultiScaleConv,TripletAttention,
            ) + C3K2_CLASS + A2C2F_CLASS + C2PSA_CLASS):
        ...
        elif m in {convnextv2_atto, convnextv2_atto_half,convnextv2_femto, convnextv2_pico, convnextv2_nano, convnextv2_tiny, convnextv2_base, convnextv2_large, convnextv2_huge,
        ...
        if verbose:
            # TODO 模型日志
            lgu.info(f"{i:>3}{str(f):>20}{n_:>3}{m_.np:10.0f}  {t:<45}{str(args):<30}")
